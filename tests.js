...
function runTests() {
    ...
    console.assert(getValidationMessage(mockField('', 'text', 10)) === 'Это поле обязательно', 'Тест 7: Пустое сообщение');
    console.assert(getValidationMessage(mockField('Коротко', 'text', 10)) === 'Минимум 10 символов', 'Тест 8: Слишком короткое сообщение');
    console.assert(getValidationMessage(mockField('Достаточно длинное сообщение', 'text', 10)) === '', 'Тест 9: Валидное сообщение');
